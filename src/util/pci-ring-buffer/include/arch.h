...
#define smp_cas_float(__ptr, __old_val, __new_val)  \
  __sync_bool_compare_and_swap(reinterpret_cast<uint32_t*>(__ptr), *reinterpret_cast<const uint32_t*>(&__old_val), *reinterpret_cast<const uint32_t*>(&__new_val))
